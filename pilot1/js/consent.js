...
const consent = {
    ...
    stimulus: '<p><b>Consent Form</b></p> <div style="text-align:left;' +
        'background-color:lightblue; padding:20px; max-width:900px; margin: auto;">' +
        ...
        " different questions about making judgments and interpreting" +
        " characters' actions. All information collected will remain" +
        ' confidential. </p>' +
