...
def analyze_gaze(icatcher_output_file, freeze_duration=8.0, anim_duration=11.32, bullseye_duration=3.0):
...
def prepare_videos(videos_dir, target_uuid=None):
    ...
    uuid), converts webm -> mp4 (cropped to start at 14.32s into the
...
def main():
    ...
    parser.add_argument("--anim_duration", default=11.32, type=float, help="Seconds between bullseye end and outcome-freeze onset (default 11.32 = part1 5.44 + anticipatory freeze 3.0 + part2 2.88 in the revised design). Only affects how many trailing frames get kept when a video has more than 650 total frames - see analyze_gaze().")
