...
const consent = {
    ...
    stimulus: '<p style="text-align: center;"><b>Consent Form</b></p> <div style="text-align:left;' +
        ...
        " people's actions. We will also record video from your webcam" +
        " to analyze your eye movements (looking patterns) during the videos. " +
        " All information collected will remain strictly confidential. </p>" +
        ...
        ' Protocol Director, (Professor Ellen Markman, Phone:' +
        ' (650) 725-2427; Email: markman@stanford.edu). </p>' +
        ...
        ' our internet-based study and consent for us to record and analyze the' +
        ' resulting webcam data. </p> </div>' +
