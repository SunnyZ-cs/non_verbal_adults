...
const debrief_page = {
    ...
    stimulus: `
        <div class="instructions-box" style="max-width: 800px; margin: 40px auto; text-align: left; line-height: 1.7; font-family: Arial, sans-serif;">
            ...
            <p style="margin-bottom: 1.5em; font-size: 1.05em; color: #444;"><strong>How this study answers the question:</strong> We record where your child looks during the final moments of the videos. If children naturally trace the responsibility back to the initiator of the event rather than the direct collider, we expect them to look longer or more frequently at the initial shape (the initiator/distal cause) than at the final shape (the direct/proximal cause) that made contact. Comparing these looking patterns allows us to see how deeply ingrained and automatic our causal reasoning is.</p>
